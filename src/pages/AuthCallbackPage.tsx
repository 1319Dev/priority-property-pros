...
export function AuthCallbackPage() {
  const { refreshProfile, account_type, account_status, signup_fee_status, loading, user } = useAuth();
  ...
  }, [loading, user, account_type, account_status, signup_fee_status, navigate]);
