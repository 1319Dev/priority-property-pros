...
export function ConnectionCheckoutReturnPage() {
  ...
  const [message, setMessage] = useState("Confirming your $4.99 payment. This page cannot unlock contact.");
  ...
  useEffect(() => {
    ...
    void reconcileConnectionCheckout(sessionId)
      .then((result) => {
        ...
        setMessage(
          granted
            ? "Payment verified. Connection access is unlocked for this project."
            : "Payment is still being verified, or it was not completed. Contact stays locked until the server confirms a $4.99 Connection Fee.",
        );
      })
