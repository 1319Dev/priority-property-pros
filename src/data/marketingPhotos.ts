...
export const MARKETING_PHOTOS: Record<MarketingPhotoId, MarketingPhotoAsset> = {
  ...
  landscaping: photo({
    ...
    alt: "A lawn professional edges a driveway with a string trimmer, throwing clippings along the concrete.",
    width: 1152,
    height: 864,
  ...
  plumbing: photo({
    ...
    alt: "A plumber uses two wrenches on a water-heater flex connector beside a tank sitting in a drain pan.",
    width: 1152,
    height: 864,
    objectPosition: "center 40%",
    widths: CARD_WIDTHS,
  ...
  electrical: photo({
    ...
    alt: "An electrician in safety glasses tightens a screw on a receptacle at an open wall box.",
    width: 1152,
    height: 864,
    objectPosition: "center 35%",
    widths: CARD_WIDTHS,
