...
export const MARKETING_PHOTOS: Record<MarketingPhotoId, MarketingPhotoAsset> = {
  hero: photo({
    ...
    alt: "A contractor reviews a job with a property owner on the walkway of a well-maintained two-story home.",
    width: 1280,
    height: 720,
  ...
  fence: photo({
    ...
    alt: "A fencing contractor fastens a cedar privacy-fence panel beside a residential house.",
    width: 1152,
    height: 864,
  ...
  landscaping: photo({
    ...
    alt: "A lawn professional mows a striped residential lawn in front of a brick house.",
    width: 1152,
    height: 864,
    objectPosition: "center 40%",
    widths: CARD_WIDTHS,
  ...
  handyman: photo({
    ...
    alt: "A handyman uses a drill and level while repairing interior door trim in a living room.",
    width: 1152,
    height: 864,
  ...
  plumbing: photo({
    ...
    alt: "A plumber works under a kitchen sink with a wrench and an open toolbox.",
    width: 1152,
    height: 864,
    objectPosition: "center 35%",
    widths: CARD_WIDTHS,
  ...
  electrical: photo({
    ...
    alt: "An electrician in safety glasses services an open residential electrical panel.",
    width: 1152,
    height: 864,
    objectPosition: "center 30%",
    widths: CARD_WIDTHS,
