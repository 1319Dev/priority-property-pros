...
export function ForContractors() {
  return (
    <section className="py-14 sm:py-16" aria-labelledby="pros-heading">
      <Container>
        <div className="overflow-hidden rounded-[2rem] bg-forest-950 text-cream-50 lg:grid lg:grid-cols-[0.9fr_1.1fr]">
          <div className="relative aspect-[16/10] max-h-56 overflow-hidden sm:max-h-64 lg:max-h-none lg:aspect-auto">
            <MarketingPhoto
              photo="electrical"
