...
export const CUSTOMER_ISOLATION_RULES = [
  ...
  "Private street, phone, email, and coordinates stay locked until contact entitlement (paid $4.99 connection or admin override), never merely because a booking is CONFIRMED.",
