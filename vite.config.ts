    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          ...
          short_name: "PPP",
          description:
            "Join Priority Property Pros for a one-time $9.99 account activation. Your project. Local pros. One simple place. A local home-services marketplace connecting property owners with independent contractors.",
          theme_color: "#1A3C2E",
